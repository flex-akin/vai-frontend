      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/60 px-4">
          <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-[#111111] p-6 text-center shadow-2xl">
            ...
            <p className="mt-1 text-sm text-white/70">Taking you to your workspace...</p>
          </div>
        </div>
      )}
      <div className="absolute inset-0">
        <div className="absolute -top-32 right-[-10%] h-72 w-72 rounded-full bg-[#4f46e5]/30 blur-[120px]" />
        <div className="absolute bottom-[-20%] left-[-10%] h-80 w-80 rounded-full bg-[#ec4899]/25 blur-[130px]" />
        ...
        <div className="grid w-full gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="flex flex-col justify-center gap-6">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {["AI captions", "Scene highlights", "Speaker turns", "Shareable summaries"].map(
                (item) => (
                  <div
                    key={item}
