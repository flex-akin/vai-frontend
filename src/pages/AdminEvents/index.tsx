      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-white/40">System event history</p>
          </div>
        </div>

        {/* Filters */}
        <div className="mb-6 rounded-2xl border border-white/10 bg-white/5 px-5 py-4">
          <p className="text-xs font-semibold uppercase tracking-wide text-white/30 mb-3">
            Filters
          </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {items.map((e) => (
                    <tr
                      key={e.id}
                      className="border-b border-white/5 last:border-0 hover:bg-white/5 transition align-top"
                    >
                      <td className="px-4 py-3 text-white/30 font-mono text-xs">{e.id}</td>
                      ...
                      <td className="px-4 py-3 text-white/40 font-mono text-xs max-w-[120px] truncate">
                        {e.session_id ?? <span className="text-white/20">—</span>}
                      </td>
                      <td className="px-4 py-3 text-white/50 text-xs">
                        {e.input_type ?? <span className="text-white/20">—</span>}
                      </td>
                      <td className="px-4 py-3 text-white/40 font-mono text-xs max-w-[200px]">
                        {e.metadata ? (
                          <span className="truncate block" title={JSON.stringify(e.metadata)}>
